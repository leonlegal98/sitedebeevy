        ...
        <div>
            ...
            <div className='containertexteatelier'>
                <div className='texteatelierarticle'>
                    <h3>
                        Journée d'écriture créative "Un air de vacances"
                    </h3>
                    <p>
                        juin 2023</p>
                    <p>-</p>
                    <p>
                        Au programme de cette journée, des galets d'enfance retrouvés sous les
                        mots, un cadavre exquis à l'ombre d'une pergola, la fraîcheur d'une carte
                        postale végétale... La production finale s'est inspirée d'un extrait du livre
                        "Souvenirs de la marée basse" de Chantal Thomas ainsi que de la première strophe
                        de la chanson "Sous mes paupières", extraite de l'album "éphémère" de Gaël Faye,
